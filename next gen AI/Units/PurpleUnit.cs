...
public class PurpleUnit : UnitClass
{
    ...
    public override void Atack(UnitClass enemy)
    {
        ...
        GreenUnit en = (GreenUnit)enemy;
     //   Debug.Log(weapon.ReturnType());

        float distance = (y - en.y) / (x - en.x);
    ...
    public override void Move(Vector3 tile)
    {
        ...
        //var heading = ray - transform.position; // direction from unit to mouse position as v3
    ...
    //public override Vector3 Move(RaycastHit ray1, Vector3 ogPos) // automove
    //{
    //    Vector3 ray = ray1.point;
    ...
    //    }
    //    ogPos += direction;
    //    Debug.Log("simply moved purple");
    //    return ogPos;
    //}

    public override void CollectData()
    {
        Debug.Log("game done purple wins");
    }
}
